...
/**
 * Watermark中的allowedLateness的使用处理
 *
 * 依次发送下面的数据:
 * a,10000
 * a,24000
 ...
 *
 * @Author: kim
 * @Description: 延迟触发窗口计算
 * @Date: 10:18 2021/5/27
 * @Version: 1.0
 */
public class WindowWordCountByWaterMark2 {

    private  static final Logger logger  = LoggerFactory.getLogger(WindowWordCountByWaterMark2.class);
